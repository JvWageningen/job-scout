...
| **Questions you ask them** | The other half of the interview: when they ask whether you have any questions, arrive with ones built from this vacancy, the company research and review already gathered, and your own CV — including the uncomfortable ones a reported weakness deserves. Grouped by theme, each with why it matters for you and what it was based on. [Interview questions guide](docs/INTERVIEW_QUESTIONS.md). |
