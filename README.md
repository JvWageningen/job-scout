...
| **Memories of what is not on your CV** | Tell job-scout the things you leave off your CV or only mention for some vacancies: a project, a result, a wish about hours, a course in progress. Add them by hand, paste any text about yourself and pick from the memories it proposes, or let the notes you type for a letter or interview be kept automatically, generalised so they stand on their own. Each memory carries tags and a hint on when it applies, and letters, interview answers and a tailored CV use the ones that fit the vacancy. Private ones are never sent to a model. Everything stays in your own database, where you can edit or delete it in the Memories tab. [Memories guide](docs/MEMORIES.md). |
...
| [docs/MEMORIES.md](docs/MEMORIES.md) | Facts about you kept for later letters, interviews and CVs: added by hand, from a text or from your notes, and what stays private |
