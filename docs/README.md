...
| [MEMORIES.md](MEMORIES.md) | How does job-scout remember what is not on my CV? Memories: facts added by hand, taken from a text or from the notes of a letter or interview, and used where they fit a vacancy; the Memories tab where you review, edit and delete them; what stays private. |
| [WRITING_STYLE.md](WRITING_STYLE.md) | Why do the drafts read the way they do? The house style every generated letter, answer, review and CV rewording follows, the clean-up applied afterwards, and the stock-phrase warning. |
